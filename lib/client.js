window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/archive-panel.tsx
		/**
		...
		*/
		function ArchivePanel({ t, onClose }) {
			...
			(0, react.useEffect)(() => {
				let cancelled = false;
				setError(null);
				callHost("list-archived", {}).then((res) => {
					if (cancelled) return;
			...
			const pruneSelected = () => {
				...
				if (!(typeof window !== "undefined" && typeof window.confirm === "function" ? window.confirm(`确认从归档数组中移除 ${ids.length} 个会话 id？\n\n${summary}\n\n将写入存储文件（自动备份），需要重启 DSH 后官方侧生效。此操作不可撤销。`) : false)) return;
				setPruning(true);
				setNote(null);
				callHostAny("archive-prune", { sessionIds: ids }, 6e4).then((res) => {
					if (res.ok) {
			...
			if (error !== null) children.push((0, react.createElement)("div", {
			...
			}, [(0, react.createElement)("div", { key: "msg" }, error === "请求超时" ? "读取归档列表超时：Host 可能正忙（如正在整理索引），稍后重试。" : error), (0, react.createElement)("button", {
				key: "retry",
				type: "button",
				...
				children.push((0, react.createElement)("div", {
					...
					(0, react.createElement)("span", {
						key: "hint",
						className: "dsws_indexLine"
					}, "清理 = 从官方归档数组移除，需重启 DSH 生效")
				]));
				children.push((0, react.createElement)("ul", {
					...
					key: item.sessionId,
					className: "dsws_row dsws_archRow"
				}, [
					(0, react.createElement)("label", {
						key: "sel",
						className: "dsws_archCheck"
					...
					(0, react.createElement)("span", {
						key: "id",
						className: "dsws_meta dsws_uuid"
					}, item.sessionId)
				]))));
			}
			return (0, react_dom.createPortal)((0, react.createElement)("div", { key: "archive-root" }, [(0, react.createElement)("div", {
				key: "backdrop",
				...
				(0, react.createElement)("div", {
					key: "head",
					className: "dsws_dialogHead"
				}, [(0, react.createElement)("span", {
					key: "title",
					className: "dsws_dialogTitle"
				}, translate(t, "panel.archived")), (0, react.createElement)("button", {
					key: "close",
					type: "button",
					className: "dsws_actBtn",
					onClick: onClose
		...
		*/
		...
		function IndexBlock(props) {
			...
			const pillState = rebuilding ? "syncing" : status?.rebuild?.state === "error" ? "error" : status === null || status.available !== true ? "neutral" : "ready";
			const pillLabel = rebuilding ? translate(t, "card.index.rebuilding", {
			...
			return (0, react.createElement)("div", {
				...
				archiveOpen && (0, react_dom.createPortal)((0, react.createElement)(ArchivePanel, {
					t,
					onClose: () => {
...
`;
		...
		function SwitchPanel({ t, onClose, onOpenArchive, open }) {
			...
			if (mode === "title") {
				...
				key: "unavailable",
				className: "dsws_error"
			}, [(0, react.createElement)("div", { key: "msg" }, searchStatus.reason === "unavailable" ? translate(t, "panel.unavailable") : translate(t, "panel.notBuilt")), (0, react.createElement)("button", {
				key: "build",
				type: "button",
				className: "dsws_actBtn",
				style: { marginTop: "6px" },
				...
				key: "tag",
				className: "dsws_tag"
			}, typeLabel(t, item.type))]), (0, react.createElement)("span", {
				key: "s",
		...
		function SwitchFooter({ t, wide, open }) {
			...
			const [openArchive, setOpenArchive] = (0, react.useState)(false);
			const closeAll = () => {
				setOpenPanel(false);
				setOpenArchive(false);
			};
			return (0, react.createElement)("div", { className: "dsws_root" }, [
				(0, react.createElement)("button", {
					key: "btn",
					type: "button",
				...
				}, [searchIcon(), wide && (0, react.createElement)("span", { key: "label" }, translate(t, "panel.entry"))]),
				...
				openArchive && (0, react.createElement)(ArchivePanel, {
					key: "archive",
					t,
					onClose: () => {
						setOpenArchive(false);
		...
		function SwitchArchiveFooter({ t, wide, open }) {
			const [openArchive, setOpenArchive] = (0, react.useState)(false);
			...
			}, [archiveIcon(), wide && (0, react.createElement)("span", { key: "label" }, translate(t, "panel.archived"))]), openArchive && (0, react.createElement)(ArchivePanel, {
				key: "archive",
				t,
				onClose: () => {
					setOpenArchive(false);
		...
		*/
		function apply(ctx) {
			...
			slots.inject("sidebar.footer.action", () => slots.register({
				name: "sidebar.footer.action",
				id: "dsh-session-search-toggle-archive",
				order: 11
			}, (props) => (0, react.createElement)(SwitchArchiveFooter, {
				...props,
				open
