...
`;
		...
		function SwitchPanel({ t, anchor, onClose, open }) {
		...
		function SwitchFooter({ t, wide, open }) {
			...
			}, [searchIcon(), wide && (0, react.createElement)("span", { key: "label" }, translate(t, "panel.titleSearch"))]), openPanel && anchor !== null && (0, react.createElement)(SwitchPanel, {
				key: "panel",
				t,
				anchor,
				onClose: () => {
