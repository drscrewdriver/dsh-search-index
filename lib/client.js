window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function ArchivePanel({ t, onClose, open }) {
			...
			if (error !== null) children.push((0, react.createElement)("div", {
				...
				key: "tag",
				className: "dsws_tag"
			}, fmtTime$1(item.updatedAt))]), item.cwd !== "" && (0, react.createElement)("span", {
				key: "c",
				className: "dsws_meta"
			}, item.cwd)])))));
			return (0, react_dom.createPortal)((0, react.createElement)("div", { key: "archive-root" }, [(0, react.createElement)("div", {
				...
				className: "dsws_actBtn",
				onClick: onClose
			}, translate(t, "panel.archived.close"))]), children])]), document.body);
		}
...
`;
		...
		function SwitchFooter({ t, wide, open }) {
			...
			return (0, react.createElement)("div", { className: "dsws_root" }, [
				...
				}, [searchIcon(), wide && (0, react.createElement)("span", { key: "label" }, translate(t, "panel.titleSearch"))]),
