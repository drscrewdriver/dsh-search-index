	...
	factory: (require) => {
		...
		*/
		function SearchSettingsCard(props) {
			...
			if (snapshot.status === "unavailable") return (0, react.createElement)("div", { className: "dsws_setRoot" }, (0, react.createElement)("div", { className: "dsws_setRow" }, (0, react.createElement)("span", { className: "dsws_setTitle" }, translate(t, "card.unavailable"))));
