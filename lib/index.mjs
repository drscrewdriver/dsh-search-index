...
*/
async function archivePrune(runtime, payload) {
	const record = payload;
...
//#endregion
export { Config, DEFAULT_CONFIG, DEFAULT_INDEX_LAYOUT, SWITCH_SEARCH_SETTINGS_NAMESPACE, SwitchIndexEngine, SwitchWatermarkSync, apply, createArchiveSource, exportSnapshot, importIntoIndex, inject, name, parseSnapshot, pruneArchiveFile, rebuildIndex, recoverIndex };
